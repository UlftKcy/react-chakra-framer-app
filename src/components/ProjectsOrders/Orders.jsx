    ...
    return (
        <Card w='100%' h="100%" color="white" px={3}>
            ...
            <CardBody>
                <List spacing={10}>
                    <Box display="flex">
                        <RepeatIcon color='yellow.300' boxSize={4} mr={3} />
                        <ListItem>
                            $2400, Design changes
                    ...
                    <Box display="flex">
                        <ArrowUpDownIcon color='green.300' boxSize={4} mr={3} />
                        <ListItem>
                            New order #4219423
                    ...
                    <Box display="flex">
                        <CalendarIcon color='purple.300' boxSize={4} mr={3} />
                        <ListItem>
                    ...
                    <Box display="flex">
                        <AddIcon color='cyan.300' boxSize={4} mr={3} />
                        <ListItem>
